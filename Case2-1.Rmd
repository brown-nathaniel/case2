...
p3<-ggplot(data = dat, aes(x=race,fill=scan))+geom_bar(position="fill") +theme_bw()+ labs(x="Race",y="Percentage",fill="Scanned or Not",title ="Proportion of Patients Who Saw Neurologist by Group") + theme(plot.title = element_text(size=12, hjust = 0.5)) +scale_y_continuous(labels=percent_format())
p4<-ggplot(data = dat, aes(x=symptom,fill=scan)) +geom_bar(position="fill") +theme_bw()+labs(x="Number of Symptoms", y="Percentage", fill="Scanned or Not",title ="Proportion of Patients Who Saw Neurologist by Group") + theme(plot.title = element_text(size=12, hjust = 0.5))+scale_y_continuous(labels=percent_format())
p5<-ggplot(data = dat, aes(x=gender,fill=scan))+geom_bar(position="fill") +theme_bw()+ labs(x="Gender",y="Percentage",fill="Scanned or Not",title ="Proportion of Patients Who Saw Neurologist by Group") + theme(plot.title = element_text(size=12, hjust = 0.5))+scale_y_continuous(labels=percent_format())
