...
These boxplots illustrate the different distributions of time to treatment by the number of symptoms one shows. The median wait times are similar, as well as the means occording to an ANOVA test for equal means between the four groups (p=`r round(p2,4)`). However, the quantiles show that the distribution tends to be concentrated for the group with more symptoms. 
