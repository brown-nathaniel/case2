...
plot(x=1:length(kernel_surv[[2]]), y=kernel_surv[[2]], type="s", xlab = "Kernels", ylab = "Survival",main= "Cumulative Kernel Survival")
...
plot(x=1:length(kernel_surv_symp0[[2]]), y=kernel_surv_symp0[[2]], type="s", col="red", plot="Survival Curves", ylab="Survival", xlab="t")
lines(x=1:length(kernel_surv_symp1[[2]]), y=kernel_surv_symp1[[2]], col="blue")
lines(x=1:length(kernel_surv_symp2[[2]]), y=kernel_surv_symp2[[2]], col="black")
lines(x=1:length(kernel_surv_raceother[[2]]), y=kernel_surv_raceother[[2]], col="green")
lines(x=1:length(kernel_surv_male[[2]]), y=kernel_surv_male[[2]],  col="magenta")
legend(4, .8, legend=c("0 Symptoms", "1 Symptom", "2 Symptoms", "Non Black/Non Hisp", "Male"),
       col=c("red", "blue", "black", "green", "magenta"), lty=1:2, cex=0.8)
