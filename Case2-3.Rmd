...
clinical presentation in time to treatment. Hence, we attempt to fit more flexible models,
such as generalized additive models with kernel smoothing, in the following section.
...
legend(3.5, .8, legend=c("0 symp", "1 Symp", "3+Symp"), col=c("red", "blue", "black"), cex=0.8)


plot(x=1:length(kernel_surv_raceother[[2]]), y=kernel_surv_raceother[[2]],type="s", col="green", main="Race Survival Curve", ylab="Survival", xlab="t")
lines(x=1:length(kernel_surv_race[[2]]), y=kernel_surv_race[[2]],type="s", col="blue")
legend(3.5, .8, legend=c("NonBlack/NonHisp", "Black/Hisp"), col=c("green", "blue"), cex=0.8)
...
legend(3.5, .8, legend=c("Male", "Female"), col=c("magenta", "black"), cex=0.8)
