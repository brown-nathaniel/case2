...
ggplot(data.race,aes(x = race, y = value, fill = scan)) + theme_bw() +
...
ggplot(data.gender,aes(x = gender, y = value, fill = scan)) + theme_bw() +
...
ggplot(data.sym,aes(x = symptom, y = value, fill = scan)) + theme_bw() +
...
colnames= c("k1", "k2", "k3", "k4", "k5", "k6", "k7", "symptom0", "symptom1", "symptom2", "raceother", "male")
