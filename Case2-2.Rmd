...
After performing logistic regression, we applied penalties to the regression because **BLANK**. LASSO Regularization has the best fit according to a deviance test, b. (the best fit depends on bin size and idk what bin size to use).
