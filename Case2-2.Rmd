...
```
The residual plot below shows no apparent pattern. The points are generally evenly spread above and below 0.
...
Nathaniel built the logistic regression model and the supporting visualizations and summary statistics. Sarah built and analyzed the Cox Proportional Hazard model. Inhee edited and added to the report.
